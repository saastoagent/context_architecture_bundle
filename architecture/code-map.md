...
subsystem-level, not per-file prose. In this public template repo, bracketed
rows are copy-ready examples and the concrete rows cover maintenance of the
bundle itself.
...
| Context architecture lifecycle | Core context, handoff, architecture, public onboarding, examples, placeholder folders, and closeout workflow docs. | `*.md`, `.github/**/*.md`, `.github/**/*.yml`, `.github/**/*.yaml`, `architecture/**/*.md`, `docs/**/*.md`, `examples/**/*.md`, `test_index/**/*.md`, `knowledgebase/**/*.md`, `plans/**/*.md`, `decisions/**/*.md`, `logs/**/*.md`, `context_checkpoints/**/*.md`, `context_history/**/*.md`, `audits/**/*.md`, `errors/**/*.md` | Session start/end prompts, live context, code map, flow index, folder ownership docs, contribution templates. | `context_pipeline.md`, `work_prompt.md`, `architecture/code-map.md`, `architecture/components/README.md` | `python scripts/check_doc_coverage.py --help`, documentation self-review | Context lifecycle changes, folder inventory changes, closeout rule changes, public onboarding changes, or architecture coverage policy changes. |
...
| Tests and validation harness | Validation code and docs that prove behavior. | `tests/**/*.py`, `test/**/*.ts`, `scripts/*.py`, `test_index/*.md`, `.github/workflows/*.yml` | Test runner commands, CI workflow, and validation docs. | `architecture/code-map.md`, `test_index/README.md` | `python -m unittest discover`, `python scripts/check_doc_coverage.py --help` | Test movement, validation command changes, CI changes, or acceptance criteria changes. |
